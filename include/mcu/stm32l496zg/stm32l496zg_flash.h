...
#define TOGGLE_DATA_CACHE_VALUE_LENGTH 1uL
#define TOGGLE_DATA_CACHE_REGISTER_OFFSET 10uL
#define TOGGLE_DATA_CACHE_VALUE_ON 1uL
#define TOGGLE_DATA_CACHE_VALUE_OFF 0uL

//ToggleInstructionCache
#define TOGGLE_INSTRUCTION_CACHE_REGISTER_ADDR &(FLASH->ACR)
#define TOGGLE_INSTRUCTION_CACHE_VALUE_LENGTH 1uL
#define TOGGLE_INSTRUCTION_CACHE_REGISTER_OFFSET 9uL
#define TOGGLE_INSTRUCTION_CACHE_VALUE_ON 1uL
#define TOGGLE_INSTRUCTION_CACHE_VALUE_OFF 0uL

//TogglePrefetchBuffer
#define TOGGLE_PREFETCH_BUFFER_REGISTER_ADDR &(FLASH->ACR)
#define TOGGLE_PREFETCH_BUFFER_VALUE_LENGTH 1uL
#define TOGGLE_PREFETCH_BUFFER_REGISTER_OFFSET 8uL
#define TOGGLE_PREFETCH_BUFFER_VALUE_ON 1uL
#define TOGGLE_PREFETCH_BUFFER_VALUE_OFF 0uL

//SetFlashLLatency
#define SET_FLASH_LATENCY_REGISTER_ADDR &(FLASH->ACR)
#define SET_FLASH_LATENCY_VALUE_LENGTH 3uL
#define SET_FLASH_LATENCY_REGISTER_OFFSET 0uL

#endif /* STM32L496ZG_FLASH_H */
